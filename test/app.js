...
describe('app', function(){
  ...
  it('should 404 without routes', function(done){
    request(createH2ExpressBridge(express))
    .get('/')
    .expect(404, done);
  })
})
...
describe('app.parent', function(){
  it('should return the parent when mounted', function(){
    var app = createH2ExpressBridge(express)
      , blog = createH2ExpressBridge(express)
      , blogAdmin = createH2ExpressBridge(express);
...
describe('app.mountpath', function(){
  it('should return the mounted path', function(){
    var admin = createH2ExpressBridge(express);
    var app = createH2ExpressBridge(express);
    var blog = createH2ExpressBridge(express);
    var fallback = createH2ExpressBridge(express);

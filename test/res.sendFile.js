...
describe('res', function(){
  describe('.sendFile(path)', function () {
    ...
    it.skip('should not error if the client aborts', function (done) {
      var app = createH2ExpressBridge(express);
      var cb = after(2, done)
      var error = null
  ...
  describe('.sendFile(path, fn)', function () {
    ...
    it.skip('should invoke the callback when client aborts', function (done) {
      var cb = after(1, done);
      var app = createH2ExpressBridge(express);
    ...
    it.skip('should invoke the callback when client already aborted', function (done) {
      var cb = after(1, done);
      var app = createH2ExpressBridge(express);
